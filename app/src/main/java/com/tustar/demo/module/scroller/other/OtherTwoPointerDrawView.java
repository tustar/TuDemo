 ...
 */
public class OtherTwoPointerDrawView extends View {
    ...
    public OtherTwoPointerDrawView(Context context) {
        super(context);
        init(context);
    }

    public OtherTwoPointerDrawView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public OtherTwoPointerDrawView(Context context, AttributeSet attrs, int defStyleAttr) {

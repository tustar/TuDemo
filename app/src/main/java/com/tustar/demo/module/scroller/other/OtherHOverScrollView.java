 ...
 */
public class OtherHOverScrollView extends LinearLayout{
    ...
    public OtherHOverScrollView(Context context) {
        super(context);
        init(context);
    }

    public OtherHOverScrollView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public OtherHOverScrollView(Context context, AttributeSet attrs, int defStyleAttr) {

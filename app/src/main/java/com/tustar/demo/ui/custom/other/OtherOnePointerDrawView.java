 ...
 */
public class OtherOnePointerDrawView extends View {
    ...
    public OtherOnePointerDrawView(Context context) {
        super(context);
        init(context);
    }
    public OtherOnePointerDrawView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }
    public OtherOnePointerDrawView(Context context, AttributeSet attrs, int defStyleAttr) {

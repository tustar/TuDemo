 ...
 */
public class OtherHScrollView extends LinearLayout {
    ...
    public OtherHScrollView(Context context) {
        super(context);
        init(context);
    }

    public OtherHScrollView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public OtherHScrollView(Context context, AttributeSet attrs, int defStyleAttr) {

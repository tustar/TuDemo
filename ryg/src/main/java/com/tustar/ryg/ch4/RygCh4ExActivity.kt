...
import kotlinx.android.synthetic.main.activity_ryg_ch4_ex.*
import kotlinx.android.synthetic.main.item_ryg_ch3_outer_layout.view.*

class RygCh4ExActivity : AppCompatActivity() {

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_ryg_ch4_ex)


        for (i in 1..3) {
            var viewGroup = layoutInflater.inflate(R.layout.item_ryg_ch3_outer_layout, ryg_ch4_ex,
                    false) as ViewGroup
    ...
    private fun createList(viewGroup: ViewGroup) {
        ...
        viewGroup.item_list_view.setOnItemClickListener { _, _, _, _ ->
            Toast.makeText(this@RygCh4ExActivity, "click item",

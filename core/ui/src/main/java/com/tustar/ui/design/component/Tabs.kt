    ...
    Tab(
        ...
        text = {
            ...
            ProvideTextStyle(
                value = style,
                content = {
                    Box(modifier = Modifier.padding(top = DemoTabDefaults.TabTopPadding)) {
                        text()
                    }
                }
            )
 ...
 * @param tabs The tabs inside this tab row. Typically this will be multiple [DemoTab]s. Each element

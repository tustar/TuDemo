...
import com.tustar.demo.ui.custom.other.OtherHOverScrollView;
import com.tustar.demo.ui.custom.other.OtherHOverScrollViewActivity;
import com.tustar.demo.ui.custom.other.OtherHScrollView;
import com.tustar.demo.ui.custom.other.OtherHScrollViewActivity;
import com.tustar.demo.ui.custom.other.OtherOnePointerDrawView;
import com.tustar.demo.ui.custom.other.OtherOnePointerDrawViewActivity;
import com.tustar.demo.ui.custom.other.OtherTwoPointerDrawView;
import com.tustar.demo.ui.custom.other.OtherTwoPointerDrawViewActivity;
...
public class ScrollerActivity extends BaseActivity implements ScrollerAdapter.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mScrollerRecyclerview.addItemDecoration(new Decoration(mContext));

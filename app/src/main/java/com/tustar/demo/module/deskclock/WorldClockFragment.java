...
public class WorldClockFragment extends Fragment {
    ...
    public static Fragment newInstance() {
        WorldClockFragment menuFragment = new WorldClockFragment();
        return menuFragment;
    }
    ...
    private WorldClockAdapter mWorldClockAdapter;
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        mSwipeMenuRecyclerView = (SwipeMenuRecyclerView) view.findViewById(R.id.deskclock_worldclock_recycler_view);
    }
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        mWorldClockAdapter = new WorldClockAdapter(mStrings);
        mWorldClockAdapter.setOnItemClickListener(onItemClickListener);
        mSwipeMenuRecyclerView.setAdapter(mWorldClockAdapter);
    }
    ...
    private SwipeMenuCreator swipeMenuCreator = new SwipeMenuCreator() {
        ...
        public void onCreateMenu(SwipeMenu swipeLeftMenu, SwipeMenu swipeRightMenu, int viewType) {
            int width = getResources().getDimensionPixelSize(R.dimen.deskclock_item_width);

            // MATCH_PARENT 自适应高度，保持和内容一样高；也可以指定菜单具体高度，也可以用WRAP_CONTENT。
            int height = ViewGroup.LayoutParams.MATCH_PARENT;

                SwipeMenuItem addItem = new SwipeMenuItem(mContext)
                        .setBackgroundDrawable(R.drawable.selector_deskclock_item_delete)
                        .setText("删除")

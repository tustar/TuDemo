...
class FmRenameActivity : BaseActivity(), SimpleListAdapter.OnItemClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mAdapter = SimpleListAdapter(mFiles.map { it -> it.name })
                ...
                .setPositiveButton(android.R.string.ok, { dialog, _ ->
                    ...
                    if (!TextUtils.isEmpty(text)) {
                        ...
                        if (oldFile.renameTo(newFile)) {
                            ...
                            mFiles = getFiles()
                            mAdapter!!.items = mFiles.map { it -> it.name }

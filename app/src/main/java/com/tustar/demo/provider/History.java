 ...
 */
public class History implements Parcelable, TuContract.HistoriesColumns {
     ...
     */
    private static final String DEFAULT_SORT_ORDER = TuDatabaseHelper.HISTORIES_TABLE_NAME + "."
            + CREATED_AT + " DESC";

...
import static com.tustar.demo.provider.TuContract.HistoriesColumns;
import static com.tustar.demo.provider.TuDatabaseHelper.HISTORIES_TABLE_NAME;
...
public class TuProvider extends ContentProvider {
    ...
    static {
        sURIMatcher.addURI(TuContract.AUTHORITY, "histories", HISTORIES);
        sURIMatcher.addURI(TuContract.AUTHORITY, "histories/#", HISTORIES_ID);
    }
...
//            if (!storageContext.moveDatabaseFrom(context, TuDatabaseHelper.DATABASE_NAME)) {
//                Logger.wtf("Failed to migrate database: %s", TuDatabaseHelper.DATABASE_NAME);
//            }
//        } else {
            storageContext = context;
//        }

        mOpenHelper = new TuDatabaseHelper(storageContext);
        return true;
    }

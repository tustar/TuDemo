...
fun DemoToggleButton(
    ...
    size: Dp = DemoToggleButtonDefaults.ToggleButtonSize,
    iconSize: Dp = DemoToggleButtonDefaults.ToggleButtonIconSize,
 ...
 */
object DemoToggleButtonDefaults {
